...
RSpec.describe WikisController, type: :controller do
	...
	context "premium/standard user doing CRUD on a wiki they don't own" do
		before do
	...
	context "premium/standard user doing CRUD on a wiki they do own" do
		before do
			login_with my_user
		end
		...
		describe "GET index" do
			...
			it "assigns public wikis and user's wikis to @wikis" do
